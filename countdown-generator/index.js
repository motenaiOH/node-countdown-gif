...
module.exports = {
    ...
    init: function (time, width = 200, height = 200, color = 'ffffff', bg = '000000', name = 'default', frames = 30, cb) {
        ...
        this.frames = this.clamp(frames, 1, 180);
    ...
    encode: function (timeResult, cb) {
        ...
        let fontFamily = 'cursive'; // monospace works slightly better
        ...
        if (typeof timeResult === 'object') {
            ...
            for (let i = 0; i < this.frames; i++) {
                ...
                if (days >= 0) {
                    string = [days, 'd ', hours, 'h ', minutes, 'm ', seconds, 's'].join('');
                }
